...
//    public static void scrollBy(int mm, int cm){
//         JavascriptExecutor jse = (JavascriptExecutor) Driver.getDriver(); jse.executeScript("window.scrollBy(0,0)", "");
//    }

    public static void tapByElement (MobileElement mobileElement) {
